...
export function KnobsBar(){
    ...
    function animatrix():void{
        setIsKnobAnimated(true)
    }
    function null_animatrix():void{
        setIsKnobAnimated(false)
    }
        ...
        className ={ `isKnobsBar ${!isKnobsbarShowing ? "notActive" : "isActive"}` }>
            {
                isKnobAnimated
                ? 
                <button className="isKnob underbar animata" 
                    onClick={null_animatrix}>
                    <small> Disable Animations </small>
                </button>
                :
                <button className="isKnob underbar animata" 
                    onClick={animatrix}>
                    <small> Animate Buttons </small>
                </button>
            }
